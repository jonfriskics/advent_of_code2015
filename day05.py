...
for string in input.split("\n"):
  ...
  bad_strings_found = False
  if "ab" in string or "cd" in string or "pq" in string or "xy" in string:
    bad_strings_found = True
  
  if enough_vowels and double_letter_found and not bad_strings_found:
    star1 += 1
...
for string in input.split("\n"):
  ...
  while pos < len(string) - 1:
    ...
    if pair in string[pos+2:]:
      contains_pair = True
      pos += 2
    else:
      pos += 1

  repeating_letter_with_one_in_between = False
  for n in range(len(string)):
    if n < len(string) - 2:
      if string[n] == string[n+2] and string[n] != string[n+1]:
        repeating_letter_with_one_in_between = True

  if contains_pair and repeating_letter_with_one_in_between:
    star2 += 1
